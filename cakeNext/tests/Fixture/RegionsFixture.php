...
class RegionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'regions_provinces' => ['type' => 'index', 'columns' => ['province_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'regions_provinces' => ['type' => 'foreign', 'columns' => ['province_id'], 'references' => ['provinces', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
