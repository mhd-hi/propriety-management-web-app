 ...
 * Photos Model
 *
 * @property \App\Model\Table\ProprietesTable&\Cake\ORM\Association\BelongsTo $Proprietes
 *
...
class PhotosTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['propriete_id'], 'Proprietes'), ['errorField' => 'propriete_id']);
